...
// tmpolary directory
	var $_FILE_PRELOAD    = 'modules/happy_liunx/preload/dir.php';
	var $_DIR_HAPPY_CACHE = 'modules/happy_linux/cache';
	var $_DIR_UNIX_TMP    = '/tmp';

	var $_exist_preload_tmp = false;
	var $_preload_tmp       = null;
	var $_dir_work          = null;
...
// utility
//---------------------------------------------------------
function &get_all_files_attr_in_dir( $dirname, $flag_sort=false, $id_as_key=false )
{
	$arr   = array();
	$false = false;
...
function &get_dirs_in_dir( $dirname, $flag_dir=false, $flag_sort=false, $id_as_key=false )
{
	$arr   = array();
	$false = false;
...
function check_open_basedir( $dir )
{
	$flag_allow = false;
...
function &get_open_basedir( $flag_slash=false )
{
	$null = null;
	$arr2 = array();
