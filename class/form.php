...
class happy_linux_form extends happy_linux_html
{
    ...
    /**
     * @return \happy_linux_form|\happy_linux_html|static
     */
     ...
     * @return mixed
     */
    public function build_form_dhtml_textarea($name, $value, $rows = 5, $cols = 50, $hiddentext = 'xoopsHiddenText', $dohtml = false)
    {
    ...
    public function build_xoops_token()
    {
        if (class_exists('XoopsMultiTokenHandler')) {
            [$token_name, $token_value] = $this->get_xoops_token($this->_TOKEN_NAME);
