...
// $Id: server_info.php,v 1.1 2010/11/07 14:59:23 ohwada Exp $
...
class happy_linux_server_info
{
    ...
    public function build_server_env()
    {
        ...
        $get_server_info = (is_object($db->conn) && 'mysqli' === get_class($db->conn)) ? 'mysqli_get_server_info' : 'mysql_get_server_info';
