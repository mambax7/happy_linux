<?php
// $Id: blocksadmin.inc.php,v 1.1 2007/05/15 04:57:58 ohwada Exp $
...
if (isset($_POST['previewblock'])) {
    ...
    $myblock->setVar('title', $myts->htmlSpecialChars($btitle));
    $myblock->setVar('content', $myts->htmlSpecialChars($bcontent));
    ...
    require XOOPS_ROOT_PATH . '/modules/happylinux/admin/myblockform.php';
...
if ('delete' == $op) {
    ...
    xoops_confirm(
        ['fct' => 'blocksadmin', 'op' => 'delete_ok', 'bid' => $myblock->getVar('bid')] + $xoopsGTicket->getTicketArray(__LINE__),
        'admin.php',
