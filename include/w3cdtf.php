...
// $Id: w3cdtf.php,v 1.1 2010/11/07 14:59:13 ohwada Exp $
...
function &happy_linux_parse_w3cdtf($datetime)
{
    ...
    if ('Z' != $timezone) {
        $offset_sign = mb_substr($timezone, 0, 1);
        $offset_hour = mb_substr($timezone, 1, 2);
        $offset_minute = mb_substr($timezone, 4, 2);
    }
