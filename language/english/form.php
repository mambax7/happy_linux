...
// form
define('_HAPPYLINUX_FORM_TITLE', 'Title');
define('_HAPPYLINUX_FORM_SUBMIT', 'Submit');
define('_HAPPYLINUX_FORM_CANCEL', 'Cancel');
define('_HAPPYLINUX_FORM_LOCATION', 'Return to');
define('_HAPPYLINUX_FORM_VISIT', 'Visit');
