...
define("_HAPPY_LINUX_CONF_CREATE_CONFIG", "Erstellen der Config-Datei");
define("_HAPPY_LINUX_CONF_BIN_PASS", "Passwort");
define("_HAPPY_LINUX_CONF_BIN_SEND", "Email senden");
define("_HAPPY_LINUX_CONF_BIN_SEND_NON", "Nicht gesendet");
define("_HAPPY_LINUX_CONF_BIN_SEND_ALWAYS", "Immer senden");
define("_HAPPY_LINUX_CONF_RSS_MANAGE", "RDF/RSS/ATOM Management");
define("_HAPPY_LINUX_CONF_RSS_MANAGE_DESC", "Erstelle und zeige RDF/RSS/ATOM");
define("_HAPPY_LINUX_CONF_SHOW_RDF", "Zeige RDF");
define("_HAPPY_LINUX_CONF_SHOW_RSS", "Zeige RSS");
define("_HAPPY_LINUX_CONF_SHOW_ATOM", "Zeige ATOM");
define("_HAPPY_LINUX_CONF_TPL_COMPILED_CLEAR", "Leere den Template-Cache");
define("_HAPPY_LINUX_CONF_RSS_CACHE_CLEAR", "Leere den RSS-Cache");
