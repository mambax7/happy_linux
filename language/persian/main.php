...
// manage
define('_HAPPY_LINUX_ADD_RECORD', 'اضاف کردن مدرک');
define('_HAPPY_LINUX_MOD_RECORD', 'ویرایش مدرک');
define('_HAPPY_LINUX_DEL_RECORD', 'حذف مدرک');
define('_HAPPY_LINUX_ADD_RECORD_SUCCEEED', 'مدرک با موفقیت اضافه شد');
define('_HAPPY_LINUX_MOD_RECORD_SUCCEEED', 'مدرک با موفقیت ویرایش شد');
define('_HAPPY_LINUX_DEL_RECORD_SUCCEEED', 'مدرک با موفقیت حذف شد');
define('_HAPPY_LINUX_ADD_RECORD_FAILD', 'خطا در اضافه کردن مدرک');
define('_HAPPY_LINUX_MOD_RECORD_FAILD', 'خطا در ویرایش مدرک');
define('_HAPPY_LINUX_DEL_RECORD_FAILD', 'خطا در حذف مدرک');
define('_HAPPY_LINUX_ERR_FILL', 'خطا: %s را وارد کنید');
define('_HAPPY_LINUX_ERR_ILLEGAL', 'خطا: %s غیر مجاز است');
...
define('_HAPPY_LINUX_KEYWORD', 'کلمات کلیدی');
define('_HAPPY_LINUX_NUM', 'هیچ');
define('_HAPPY_LINUX_NO_ACTION', 'بدون فعالیت');
