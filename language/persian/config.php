...
// template
define('_HAPPY_LINUX_CONF_TPL_COMPILED_CLEAR', 'کش های تالیف شده از تمپلیت ها را تمیز کن');
define('_HAPPY_LINUX_CONF_TPL_COMPILED_CLEAR_DIR', 'باید اجرا شود, وقتی فایل های تمپلیت در شاخه %s عوض شد');
define('_HAPPY_LINUX_CONF_RSS_CACHE_CLEAR', 'خالی کردن کش RSS');
define('_HAPPY_LINUX_CONF_RSS_CACHE_CLEAR_DESC', 'در حالت کابر مهمان, کش RSS برای یک ساعت');
define('_HAPPY_LINUX_CONF_RSS_CACHE_CLEAR_TIME', 'در حالت کاربر مهمان, کش RSS برای %s ساعت');
define('_HAPPY_LINUX_CONF_RSS_CACHE_TIME', 'زمان کش (ثانیه)');

define('_HAPPY_LINUX_CONF_NOT_WRITABLE', 'این شاخه قابل نوشتن نیست');

// 2007-11-24
// table manage
define('_HAPPY_LINUX_CONF_TABLE_MANAGE', 'مدیریت جدول های پایگاه داده ها');
define('_HAPPY_LINUX_CONF_TABLE_CHECK', 'برسی %s جدول');
